      ...
      <form action="{{ route('login') }}" method="POST" autocomplete="off">
        ...
        <div class="space-y-6">
          <div>
            ...
            <x-text-input id="email" type="email" name="email" class="w-full" required placeholder="Enter email" autofocus />
        ...
        <div class="grid md:grid-cols-2 gap-4">
          <button type="button"
            class="w-full px-4 py-2.5 flex items-center justify-center rounded-md text-slate-900 text-sm font-medium tracking-wider cursor-pointer border border-slate-300 hover:bg-slate-50 transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 inline shrink-0 mr-2" viewBox="0 0 512 512">
              <path fill="#fbbd00"
          ...
          <button type="button"
            class="w-full px-4 py-2.5 flex items-center justify-center rounded-md text-slate-900 text-sm font-medium tracking-wider cursor-pointer border border-slate-300 hover:bg-slate-50 transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 inline shrink-0 mr-2" fill="#000" viewBox="0 0 22.773 22.773">
        ...
        <div class="mt-4">
          <button type="button"
            class="w-full px-4 py-2.5 flex items-center justify-center rounded-md text-white text-sm font-medium tracking-wider cursor-pointer border-0 outline-0 bg-[#1877F2] hover:bg-[#166fe5] transition-colors">
            <svg xmlns="http://www.w3.org/2000/svg" class="w-5 h-5 inline shrink-0 mr-2" fill="currentColor" viewBox="0 0 167.657 167.657">
              <path d="M83.829.349C37.532.349 0 37.881 0 84.178c0 41.523 30.222 75.911 69.848 82.57v-65.081H49.626v-23.42h20.222V60.978c0-20.037 12.238-30.956 30.115-30.956 8.562 0 15.92.638 18.056.919v20.944l-12.399.006c-9.72 0-11.594 4.618-11.594 11.397v14.947h23.193l-3.025 23.42H94.026v65.653c41.476-5.048 73.631-40.312 73.631-83.154 0-46.273-37.532-83.805-83.828-83.805z" data-original="#010002"></path>
            </svg>
            Continue with Facebook
          </button>
        </div>
        <p class="text-slate-600 text-sm mt-6 text-center">Don't have an account? <a href="{{ route('register') }}" class="text-blue-600 font-medium hover:underline ml-1">Register here</a></p>
      </form>
    </div>
  </div>
</x-layouts.guest-layout>
